...
const ArcadeButton = (_a) => {
    var { backgroundColor = '#f97316', paddingVertical = 12, paddingHorizontal = 24, buttonRadius = 12, thickness = 8, hasBorder = true, disabled = false, isLoading = null, onPress, isFullWidth = false, children } = _a, args = __rest(_a, ["backgroundColor", "paddingVertical", "paddingHorizontal", "buttonRadius", "thickness", "hasBorder", "disabled", "isLoading", "onPress", "isFullWidth", "children"]);
